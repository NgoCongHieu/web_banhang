...
class ProductController extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('title', 'Title', 'trim|required', ['required' => 'Bạn nên cung cấp %s']);
        $this->form_validation->set_rules('price', 'Price', 'trim|required', ['required' => 'Bạn nên cung cấp %s']);
        $this->form_validation->set_rules('slug', 'Slug', 'trim|required', ['required' => 'Bạn nên cung cấp %s']);
        $this->form_validation->set_rules('quantity', 'Slug', 'trim|required', ['required' => 'Bạn nên cung cấp %s']);
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $new_name = time() . "" . str_replace(' ', '-', $ori_filename);  //hinh1232546.jpg
            $config = [
